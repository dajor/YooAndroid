    ...
    public static ImageCache getInstance(Activity activity, ImageCacheParams cacheParams) {
       ...
       ImageCache imageCache = null; 
        /*if(Configuration.getInstance() !=null) {
        	Configuration.getInstance().getImageCache();
        }

        // No existing ImageCache, create one and store it in RetainFragment
        if (imageCache == null) {
        	System.out.println("================== create new image cache ************** ============= " ); 
            imageCache = new ImageCache(cacheParams);
            if(Configuration.getInstance() !=null) {
                 Configuration.getInstance().setImageCache(imageCache);
            }
        }*/
       ...
       if (imageCache == null) {
       	System.out.println("================== create new image cache ************** ============= " ); 
           imageCache = new ImageCache(cacheParams);
           // YooApplication.setImageCache(imageCache);
       }
