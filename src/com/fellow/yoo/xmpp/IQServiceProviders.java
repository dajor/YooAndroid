...
public class IQServiceProviders {
    ...
    public static void Register_Providers(ProviderManager pm) {
        ...
        try {
        	...
        	Log.e("ServiceProviders : ClassNotFoundException ", e.toString());
        }
        ...
        // Opm.addIQProvider("query", "http://jabber.org/protocol/bytestreams", new BytestreamsProvider());
